...
from gravnet.utils.datasets import NoiseExtData
...
train_dataset = NoiseExtData(root="gw_data", split="train", download=True)
val_dataset = NoiseExtData(root="gw_data", split="val", download=False)
