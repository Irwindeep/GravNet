...
train_dataset = ParamEstData(root="gw_data", split="train", download=True)
val_dataset = ParamEstData(root="gw_data", split="val", download=False)
test_dataset = ParamEstData(root="gw_data", split="test", download=False)
